...
public:
	...
	// Faster to work wWrite int64
	Writer& Precision(double d, EPrecision::Type _ePrecision)	{ Prefix(kNumberType); WritePrecision(d,  _ePrecision); return *this; }
...
protected:
	...
	void WritePrecision(double d, EPrecision::Type _ePrecision) 
	{
		WriteInt64((int64_t)(d * _ePrecision));
	}
