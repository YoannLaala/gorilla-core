...
\endcode
	...
	*/
	...
	double GetPrecision(EPrecision::Type _ePrecision) const	{ RAPIDJSON_ASSERT(flags_ & kInt64Flag); return data_.n.i64 / (double)_ePrecision; }

	// Faster to work with int64 then convert it to float
	float GetMeter() const		{ RAPIDJSON_ASSERT(flags_ & kInt64Flag); return data_.n.i64 / RAPIDJSON_MICROMETER_FACTOR; }
